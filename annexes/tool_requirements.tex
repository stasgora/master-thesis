...
\centertable{
	...
	\tabreq{heat_map}{Tworzenie mapy cieplnej}{3}
	...
	\tabreq{on_off}{Możliwość wyłączenia działania}{1}
	\tabreq{dynamic_config}{Możliwość zmiany konfiguracji w trakcie działania}{1}
...
\begin{enumerate}[label=\textbf{F.\arabic*}]
	...
	\reqheader{heat_map}{Tworzenie mapy cieplnej} Podstawowym celem narzędzia jest przetwarzanie interakcji użytkownika z aplikacją na ich graficzną reprezentację w formie mapy cieplnej. 
	...
	\reqheader{on_off}{Możliwość wyłączenia działania} Pomimo że narzędzie służy do testów będzie działać w środowisku docelowym. Pojawia się zatem potrzeba możliwości łatwego włączenia i wyłączenia jego działania.

...
Pierwszym środowiskiem, które wspierał Google Analytics były strony internetowe. Wsparcie zostało potem rozszerzone~o~platformy mobilne wraz~z~wydaniem ``Google Analytics for Mobile Apps''. Oprócz tego Google Analytics jest częścią platformy \nameref{sec:firebase} omówionej~w~kolejnym podrozdziale.

\bigskip
\img{\chapterPath/analytics-dashboard.png}{Panel główny konsoli Google Analytics}{ga-dashboard}{.7}

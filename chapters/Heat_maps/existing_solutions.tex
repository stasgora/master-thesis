...
Pomimo~że~\nameref{sec:hotjar} jest liderem~w~dziedzinie analizy zachowania użytkowników przy użyciu map cieplnych interakcji, posiada szereg ograniczeń, zarówno~w~zakresie wsparcia platform jak~i~oferowanych funkcji. Wskazują one potencjalne kierunki rozwoju tego typu rozwiązań mogące znacznie zwiększyć ich użyteczność~i~grono klientów. Rozwiązania oferowane~przez~\nameref{sec:matomo_heatmap} oraz \nameref{sec:smartlook}~w~zakresie tworzenia map cieplnych są,~z~wyjątkiem wspieranych platform, praktycznie identyczne~do~usługi \nameref{sec:hotjar}.  Mała ilość tego typu rozwiązań połączona~z~brakiem innowacji może wskazywać~na~ograniczoną wiedzę~o~ich istnieniu~i~potencjalnych zaletach zastosowania.

...
Spośród pozostałych zastosowań wyróżniają się te współtworzące inteligentny dom, jak na przykład sterowanie oświetleniem zależnie od wykrytej aktywności \cite{36_Smart_Home_HAR} a także te związane z wykrywaniem aktywności sportowych \cite{29_Daily_Sport_HAR} które możnaby zintegrować z istniejącymi platformami takimi jak \textit{Strava}.
...
Duża część eksperymentów skupia się na rozpoznawaniu prostych, ``niskopoziomowych'' aktywności. Charakteryzują się one któtkim czasem trwania i małym skomplikowaniem przy wykrywaniu. Kolejnym poziomem abstrakcji, którego podejmuje się niewielka część przestudiowanych publikacji, jest złożenie tych prostych aktywności i próba wywnioskowania na ich postawie bardziej złożonych, dłużej trwających aktywności.
\cite{38_High_Lvl_HAR}

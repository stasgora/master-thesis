...
{\bf Uwaga:} Niektóre~z~artykułów zostały zaliczone~do~więcej niż jednej kategorii,~przez~co~suma wartości poniższej tabeli \ref{tab:area_classification} jest wyższa~od~rzeczywistej liczby analizowanych artykułów. Połowa przeglądów zawierała jednocześnie meta-analizę wybranego zbioru innych opublikowanych eksperymentów.
...
}{c x{3cm} x{2.2cm} x{4cm}}{Podział~na~typy artykułów}{area_classification}
